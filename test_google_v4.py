...
from cinder.tests.unit.backup import fake_google_discovery
#CONF = cfg.CONF
...
class GoogleBackupDriverTestCase(test.TestCase):
    ...
    def setUp(self):
        ...
        self.stubs.Set(google_dr.discovery, 'build', fake_google_discovery.FakeGoogleDiscovery.Build) 
