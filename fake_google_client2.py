...
class FakeGoogleObject(object):
    ...
    def insert(self, *args, **kwargs):
        ...
        print "object path for writing", object_path
    ...
    def get_media(self, *args, **kwargs):
        print "get_media of FakeGoogleObject"
